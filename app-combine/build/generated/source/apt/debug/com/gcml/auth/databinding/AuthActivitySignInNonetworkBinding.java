...
public class AuthActivitySignInNonetworkBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    // variables
    @Nullable
    private com.gcml.auth.ui.signin.nonetwork.SignInNoNetworkActivity mPresenter;
    @Nullable
    ...
    public AuthActivitySignInNonetworkBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        setRootTag(root);
        // listeners
        mCallback55 = new android.databinding.generated.callback.OnClickListener(this, 1);
        mCallback56 = new android.databinding.generated.callback.OnClickListener(this, 2);
        mCallback59 = new android.databinding.generated.callback.OnClickListener(this, 5);
        mCallback57 = new android.databinding.generated.callback.OnClickListener(this, 3);
        mCallback60 = new android.databinding.generated.callback.OnClickListener(this, 6);
        mCallback58 = new android.databinding.generated.callback.OnClickListener(this, 4);
        mCallback61 = new android.databinding.generated.callback.OnClickListener(this, 7);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.presenter == variableId) {
            setPresenter((com.gcml.auth.ui.signin.nonetwork.SignInNoNetworkActivity) variable);
        }
    ...
    public void setPresenter(@Nullable com.gcml.auth.ui.signin.nonetwork.SignInNoNetworkActivity Presenter) {
    ...
    @Nullable
    public com.gcml.auth.ui.signin.nonetwork.SignInNoNetworkActivity getPresenter() {
        return mPresenter;
    }
    ...
    protected void executeBindings() {
        ...
        com.gcml.auth.ui.signin.nonetwork.SignInNoNetworkActivity presenter = mPresenter;
        // batch finished
        if ((dirtyFlags & 0x4L) != 0) {
            // api target 1

            this.ivBack.setOnClickListener(mCallback59);
            this.ivWifiState.setOnClickListener(mCallback60);
            this.mboundView0.setOnClickListener(mCallback55);
            this.tvFaceAuth.setOnClickListener(mCallback57);
            this.tvForgetPassword.setOnClickListener(mCallback58);
            this.tvProtocol.setOnClickListener(mCallback61);
            this.tvSignIn.setOnClickListener(mCallback56);
        }
    }
    ...
    @NonNull
    public static AuthActivitySignInNonetworkBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static AuthActivitySignInNonetworkBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<AuthActivitySignInNonetworkBinding>inflate(inflater, com.gcml.auth.R.layout.auth_activity_sign_in_nonetwork, root, attachToRoot, bindingComponent);
    }
    @NonNull
    public static AuthActivitySignInNonetworkBinding inflate(@NonNull android.view.LayoutInflater inflater) {
        return inflate(inflater, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static AuthActivitySignInNonetworkBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.gcml.auth.R.layout.auth_activity_sign_in_nonetwork, null, false), bindingComponent);
    }
    @NonNull
    public static AuthActivitySignInNonetworkBinding bind(@NonNull android.view.View view) {
        return bind(view, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static AuthActivitySignInNonetworkBinding bind(@NonNull android.view.View view, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        if (!"layout/auth_activity_sign_in_nonetwork_0".equals(view.getTag())) {
            throw new RuntimeException("view tag isn't correct on view:" + view.getTag());
        }
        return new AuthActivitySignInNonetworkBinding(bindingComponent, view);
    }
    /* flag mapping
