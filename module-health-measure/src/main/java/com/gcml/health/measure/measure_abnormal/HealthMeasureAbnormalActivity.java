...
public class HealthMeasureAbnormalActivity extends ToolbarBaseActivity implements HealthMeasureChooseAbnormalReason {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mTitleText.setText(R.string.title_measuring_abnormality);
        MLVoiceSynthetize.startSynthesize(UM.getApp(), UM.getString(R.string.data_differs_greatly_from_standard_value));
        initFragment();
    }
