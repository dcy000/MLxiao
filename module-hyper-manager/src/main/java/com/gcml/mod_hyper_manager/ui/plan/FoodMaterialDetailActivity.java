...
public class FoodMaterialDetailActivity extends ToolbarBaseActivity {
    ...
    private void dealData() {
        ...
        MLVoiceSynthetize.startSynthesize(UM.getApp(),""+data.getNutrition()+"适用人群"+suitableHuman+"禁忌人群"+tabooHuman+"食量建议"+foodIntake);
    }
