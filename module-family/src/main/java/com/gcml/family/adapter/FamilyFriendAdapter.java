...
public class FamilyFriendAdapter extends BaseQuickAdapter<FamilyBean, BaseViewHolder> {

    public FamilyFriendAdapter(int layoutResId, @Nullable List<FamilyBean> data) {
