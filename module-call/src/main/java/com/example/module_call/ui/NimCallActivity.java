...
import com.example.module_call.R2;
import com.example.module_call.service.CallAPI;
...
public class NimCallActivity extends ToolbarBaseActivity {
    ...
    @BindView(R2.id.iv_call_small_cover)
    ImageView ivSmallCover;
    @BindView(R2.id.fl_call_small_container)
    FrameLayout flSmallContainer;
    @BindView(R2.id.fl_call_large_container)
    FrameLayout flLargeContainer;
    @BindView(R2.id.tv_call_time)
    TextView tvCallTime;
    @BindView(R2.id.iv_call_peer_avatar)
    ImageView ivPeerAvatar;
    @BindView(R2.id.tv_call_nickname)
    TextView tvNickname;
    @BindView(R2.id.tv_call_status)
    TextView tvStatus;
    @BindView(R2.id.ic_call_switch_camera)
    ImageView ivSwitchCamera;
    @BindView(R2.id.iv_call_toggle_camera)
    ImageView ivToggleCamera;
    @BindView(R2.id.iv_call_toggle_mute)
    ImageView ivToggleMute;
    @BindView(R2.id.iv_call_hang_up)
    ImageView ivHangUp;
    @BindView(R2.id.tv_call_receive)
    TextView tvReceive;
    @BindView(R2.id.tv_call_refuse)
    TextView tvRefuse;
    @BindView(R2.id.cl_call_root)
...
//                break;
    ...
    private final Runnable refreshCallTime = new Runnable() {
        ...
        public void run() {
            ...
            tvCallTime.setText(formatCallTime(mSeconds));
            mSeconds++;
        }
    };
    ...
    @OnClick(R2.id.iv_call_toggle_mute)
