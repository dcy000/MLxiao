package com.gcml.common.utils.qrcode;

import android.graphics.Bitmap;

import com.gcml.common.utils.display.ImageUtils;
import com.gcml.common.utils.qrcode.scaner.BitmapLuminanceSource;
...
public class DecodeQrBarUtils {
    ...
    public static Result decodeFromPhoto(Bitmap photo) {
        ...
        if (photo != null) {
            Bitmap smallBitmap = ImageUtils.zoomBitmap(photo, photo.getWidth() / 2, photo.getHeight() / 2);// 为防止原始图片过大导致内存溢出，这里先缩小原图显示，然后释放原始Bitmap占用的内存
