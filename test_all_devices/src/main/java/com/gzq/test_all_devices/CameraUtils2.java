...
import com.gcml.lib_utils.qrcode.scaner.PlanarYUVLuminanceSource;
...
public class CameraUtils2 {
    ...
    private static volatile CameraUtils2 singleton = null;
    ...
    private CameraUtils2() {
    }

    public static CameraUtils2 getInstance() {

        if (singleton == null) {
            synchronized (CameraUtils2.class) {
                if (singleton == null) {
                    singleton = new CameraUtils2();
                }
            }
        }
        return singleton;
     ...
     */
    public CameraUtils2 init(Activity activity, SurfaceView surfaceView, int previewWidth, int previewHeight, Rect rect) {
     ...
     */
    public CameraUtils2 init(Activity activity, SurfaceView surfaceView, int previewWidth, int previewHeight, int cropWidth, int cropHeight) {
        this.surfaceView = surfaceView;
        this.previewWidth = previewWidth;
        this.previewHeight = previewHeight;
        ...
        if (hasSurface) {
            ...
            surfaceHolder.addCallback(new SurfaceHolder.Callback() {
                ...
                public void surfaceDestroyed(SurfaceHolder holder) {
                    hasSurface = false;
                    if (callBack != null) {
                        callBack.openCameraFail(new Exception("surface destroy"));
                    }
                }
            });
