 ...
 * 原发性高血压问卷
 */
public class PrimaryHypertensionActivity extends ToolbarBaseActivity implements MultipleChoiceFragment.OnButtonClickListener {
    ...
    private void initVP() {
        showLoading("正在加载...");
        new HyperRepository()
                .getPrimaryHypertensionQuestion()
...
//        mRightView.setOnClickListener(v -> startActivity(new Intent(PrimaryHypertensionActivity.this, WifiConnectActivity.class)));
    ...
    private void postData() {
        new HyperRepository()
                .postPrimaryHypertensionQuestion(UserSpHelper.getUserId(), postBean)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .as(RxUtils.autoDisposeConverter(this))
