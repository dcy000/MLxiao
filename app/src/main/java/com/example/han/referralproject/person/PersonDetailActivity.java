...
import com.example.han.referralproject.person.adapter.PersonDetailFragmentPagerAdapter;
...
public class PersonDetailActivity extends ToolbarBaseActivity implements View.OnClickListener {
    ...
    public int layoutId(Bundle savedInstanceState) {
        return com.example.module_person.R.layout.activity_person_detail;
    }

    @Override
    public void initParams(Intent intentArgument) {
        MLVoiceSynthetize.startSynthesize(com.example.module_person.R.string.person_info);
    ...
    private BroadcastReceiver wifiChangedReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (level <= 0 && level >= -50) {
                mRightView.setImageResource(com.example.module_person.R.drawable.white_wifi_3);
            } else if (level < -50 && level >= -70) {
                mRightView.setImageResource(com.example.module_person.R.drawable.white_wifi_2);
            } else if (level < -70) {
                mRightView.setImageResource(com.example.module_person.R.drawable.white_wifi_1);
            }
        }
    };
    ...
    public void initView() {
        ...
        mRightView.setImageResource(com.example.module_person.R.drawable.icon_wifi);
