...
public class SignUp14DiseaseHistoryActivity extends VoiceToolBarActivity {
    ...
    public int layoutId(Bundle savedInstanceState) {
        return R.layout.activity_sign_up14_disease_history;
    }
            ...
            if (data != null) {
                ...
                switch (extra) {
                    case FaceConstants.AUTH_FACE_SUCCESS:
                        emitEvent("Skip2RecoDocActivity");
                        break;
