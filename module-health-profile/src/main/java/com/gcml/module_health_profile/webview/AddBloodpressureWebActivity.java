...
public class AddBloodpressureWebActivity extends BaseX5WebViewActivity {
...
//        webView.addJavascriptInterface(this, "addSubmit");
    ...
    protected void onWebViewPageFinished(WebView webView) {
        webView.loadUrl("javascript:uniqueMark('高血压')");
     ...
     */
    @JavascriptInterface
    public static void move2Next(String healthRdCord){
