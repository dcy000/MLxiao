...
public class VideoCallActivity extends CallActivity {
     ...
     */
    @OnClick({
            R.id.layout_call_control,
            R.id.btn_exit_full_screen,
            R.id.btn_change_camera_switch,
            R.id.btn_mic_switch,
            R.id.btn_camera_switch,
            R.id.btn_speaker_switch,
            R.id.btn_record_switch,
            R.id.btn_screenshot,
    ...
    private void onRecordCall() {
        ...
        if (recordSwitch.isActivated()) {
            ...
            // 先创建文件夹
            String dirPath =  externalFilesDir.getAbsolutePath() + "/videos";
