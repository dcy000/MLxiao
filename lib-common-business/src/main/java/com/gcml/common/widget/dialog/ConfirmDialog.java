...
public class ConfirmDialog {
    ...
    public ConfirmDialog builder() {
        ...
        View view = LayoutInflater.from(context).inflate(
                R.layout.layout_confirm_alert_dialog, null);
    ...
    public ConfirmDialog setMsg(Spanned spanned){
        showMsg=true;
        if (spanned==null){
            txt_msg.setText("内容");
        }else{
    ...
    public ConfirmDialog setPositiveButton(String text, final View.OnClickListener listener) {
        showPosBtn = true;
        if ("".equals(text)) {
            btn_pos.setText("确定");
        } else {
