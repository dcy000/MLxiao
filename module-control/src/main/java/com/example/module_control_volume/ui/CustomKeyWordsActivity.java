...
import com.example.module_control_volume.adapter.KeyWordRVAdapter;
import com.gcml.common.recommend.bean.get.KeyWordBean;
...
public class CustomKeyWordsActivity extends ToolbarBaseActivity implements KeyWordRVAdapter.ClickItemInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initTitle();
        initRV();
        MLVoiceSynthetize.startSynthesize(UM.getApp(),"请选择要定义的关键词");
    }
