package com.gcml.common.widget.fdialog;
    ...
    private void initParams() {
        ...
        if (window != null) {
            ...
            if (width == 0) {
                ...
                lp.width = ScreenUtils.getScreenW() - 2 * ScreenUtils.dip2px(margin);
            } else if (width == -1) {
                lp.width = WindowManager.LayoutParams.WRAP_CONTENT;
            } else {
                lp.width = ScreenUtils.dip2px(width);
            }
            ...
            if (height == 0) {
                ...
                lp.height = ScreenUtils.dip2px(height);
            }
