...
public class QaApi {
    public static OkHttpClient client = OkHttpClientHelper.get();
    ...
    private static String getDeviceId() {
        return Settings.System.getString(AppDelegate.INSTANCE.app().getContentResolver(), Settings.System.ANDROID_ID);
    }
