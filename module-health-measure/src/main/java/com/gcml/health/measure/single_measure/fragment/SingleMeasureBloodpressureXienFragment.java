 ...
 * version: V1.3.0
 * created on 2018/10/22 17:00
 * created by: gzq
 * description: 西恩单测
 */
public class SingleMeasureBloodpressureXienFragment extends Bloodpressure_Xien_Fragment{
    ...
    public SingleMeasureBloodpressureXienFragment() {
    }
                    ...
                    .subscribeWith(new DefaultObserver<Object>() {
                        ...
                        public void onError(Throwable e) {
                            HealthMeasureAbnormalActivity.startActivity(
                                    SingleMeasureBloodpressureXienFragment.this,
