...
public class UerInfoListFragment extends RecycleBaseFragment implements View.OnClickListener {
    /**
     * 最新建档时间：2018年1月21日
     */
    ...
    public static UerInfoListFragment instance(String recordId, String selfRecordId) {
        ...
        UerInfoListFragment healthFileFragment = new UerInfoListFragment();
        ...
        rxUsers.subscribeOn(Schedulers.io())
                ...
                .subscribe(new com.gcml.common.utils.DefaultObserver<UserEntity>() {
                    ...
                    public void onNext(UserEntity user) {
                        ...
                        mTvDisease.setText(TextUtils.isEmpty(user.phone) ? UM.getString(R.string.no_data) : user.phone);
                        mTvDoctor.setText(TextUtils.isEmpty(user.bloodType) ? UM.getString(R.string.no_data) : user.bloodType);
                    }
                });
