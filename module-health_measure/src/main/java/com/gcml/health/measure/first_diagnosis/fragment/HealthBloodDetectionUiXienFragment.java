...
public class HealthBloodDetectionUiXienFragment extends Bloodpressure_Xien_Fragment {
    ...
    protected void clickHealthHistory(View view) {
        if (isMeasureOver) {
            if (fragmentChanged != null && !isJump2Next) {
                fragmentChanged.onFragmentChanged(HealthBloodDetectionUiXienFragment.this, null);
            }
        } else {
