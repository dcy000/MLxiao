...
public class MeasureVideoPlayActivity extends AppCompatActivity implements IJump2NextListener {
    ...
    public static void startForResultActivity(Activity context, Uri uri, String url, String title,int requestCode){
        Intent intent = new Intent(context, MeasureVideoPlayActivity.class);
        intent.putExtra("uri", uri);
        intent.putExtra("url", url);
        intent.putExtra("title", title);
        ...
        public void onPlayerEvent(int eventCode, Bundle bundle) {
            switch (eventCode) {
                ...
                case OnPlayerEventListener.PLAYER_EVENT_ON_PLAY_COMPLETE:
                    setResult(RESULT_OK,new Intent().putExtra("result", SendResultActionNames.VIDEO_PLAY_END));
                    finish();
                    break;
        ...
        public void onAssistHandle(BaseVideoView assist, int eventCode, Bundle bundle) {
            ...
            switch (eventCode) {
                ...
                case DataInter.Event.EVENT_CODE_REQUEST_BACK:
                    setResult(RESULT_OK,new Intent().putExtra("result",SendResultActionNames.PRESSED_BUTTON_BACK));
                    finish();
...
//                    }
    ...
    public void clickJump2Next(View view) {
        setResult(RESULT_OK,new Intent().putExtra("result",SendResultActionNames.PRESSED_BUTTON_SKIP));
        finish();
    }
}
