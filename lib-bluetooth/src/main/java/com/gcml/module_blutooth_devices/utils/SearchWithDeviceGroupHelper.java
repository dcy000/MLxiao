...
import com.gcml.module_blutooth_devices.permission.PermissionsManager;
import com.gcml.module_blutooth_devices.permission.PermissionsResultAction;
...
public class SearchWithDeviceGroupHelper implements Comparator<SearchResult> {
    ...
    public SearchWithDeviceGroupHelper(IView view, int measureType, BoShengUserBean userBean) {
        this.view = view;
        this.measureType = measureType;
        devices = new ArrayList<>();
