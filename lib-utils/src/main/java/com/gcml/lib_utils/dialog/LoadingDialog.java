package com.gcml.lib_utils.dialog;
...
import com.gcml.lib_utils.widget.LoadingView;
    ...
    public static class Builder {
        ...
        public LoadingDialog create(boolean cancelable) {
            ...
            if (mCurrentIconType == ICON_TYPE_LOADING) {
                ...
                loadingView.setSize(ScreenUtils.dip2px(64));
                ...
                LinearLayout.LayoutParams imageViewLP = new LinearLayout.LayoutParams(ScreenUtils.dip2px(64), ScreenUtils.dip2px(64));
            ...
            if (mTipWord != null && mTipWord.length() > 0) {
                ...
                if (mCurrentIconType != ICON_TYPE_NOTHING) {
                    tipViewLP.topMargin = ScreenUtils.dip2px(24);
                }
