...
public class FactoryMeasureChooseDeviceActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void startActivity(Context context, boolean isFaceSkip) {
        Intent intent = new Intent(context, FactoryMeasureChooseDeviceActivity.class);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.ll_xueya) {
            ...
            FactotyAllMeasureActivity.startActivity(this, measureType);
...
//            AllMeasureActivity.startActiv(this, measureType);
    ...
    private void aferVideo() {
        ...
        intent.setClass(this, FactotyAllMeasureActivity.class);
