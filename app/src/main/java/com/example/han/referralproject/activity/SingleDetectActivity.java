...
public class SingleDetectActivity extends BaseActivity implements View.OnClickListener {
    ...
    private final static String TAG = SingleDetectActivity.class.getSimpleName();
...
//                startActivity(new Intent(SingleDetectActivity.this, MeasureXueyaResultActivity.class)
...
//                }
    ...
    private void uploadXuetangResult(final float xuetangResut, final boolean status, final Fragment fragment) {
        ...
        NetworkApi.postData(info, new NetworkManager.SuccessCallback<MeasureResult>() {
            @Override
            public void onSuccess(MeasureResult response) {
//                startActivity(new Intent(SingleDetectActivity.this, MeasureXuetangResultActivity.class)
                    ...
                    case Type_TiZhong:
                        if (notifyData != null && notifyData.length == 14 && (notifyData[1] & 0xff) == 221) {
                            if (isGetResustFirst) {
                                ...
                                String height_s = LocalShared.getInstance(SingleDetectActivity.this).getSignUpHeight()+"";
...
//                Log.i("mylog", "33333333333333333333333");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_detect);
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SingleDetectActivity.this, HealthRecordActivity.class);
        ...
        findViewById(R.id.history5).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!s_one.equals("0")) {
                    startActivity(new Intent(SingleDetectActivity.this, HealthRecordActivity.class).putExtra("position", 2));
                } else if (!s_two.equals("0")) {
                    startActivity(new Intent(SingleDetectActivity.this, HealthRecordActivity.class).putExtra("position", 6));
                } else if (!s_three.equals("0")) {
                    startActivity(new Intent(SingleDetectActivity.this, HealthRecordActivity.class).putExtra("position", 5));
                } else {
                    startActivity(new Intent(SingleDetectActivity.this, HealthRecordActivity.class).putExtra("position", 2));
                }
//                startActivity(new Intent(SingleDetectActivity.this, HealthRecordActivity.class).putExtra("position", 6));
        ...
        findViewById(R.id.history6).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SingleDetectActivity.this, HealthRecordActivity.class).putExtra("position", 8));
            }
        });
            ...
            findViewById(R.id.detect_tv_result_next).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if ("detectHealth".equals(detectCategory)) {
                        switch (type) {
                            case "wendu":
                                Intent intent3 = new Intent(SingleDetectActivity.this, SingleDetectActivity.class);
                            ...
                            case "xueya":
                                if (intent.getBooleanExtra("is_right", false)) {
                                    Intent intent4 = new Intent(SingleDetectActivity.this, XinDianDetectActivity.class);
                                ...
                                Intent intent4 = new Intent(SingleDetectActivity.this, SingleDetectActivity.class);
                                intent4.putExtras(getIntent());
                                ...
                                break;
                            case "tizhong":
                                Intent intent1 = new Intent(SingleDetectActivity.this, DetectHealthSymptomsActivity.class);
                    ...
                    if ("detectSugar".equals(detectCategory)) {
                        switch (type) {
                            case "xueya":
                                ...
                                break;
                            case "xuetang":
                                Intent intent5 = new Intent(SingleDetectActivity.this, SingleDetectActivity.class);
                    ...
                    switch (type) {
                        case "tizhong":
                            Intent intent1 = new Intent(SingleDetectActivity.this, DetectResultActivity.class);
                            intent1.putExtras(getIntent());
                            intent1.putExtra("weight", mResultTv.getText().toString());
                            ...
                            break;
                        case "xueyang":
                            Intent intent2 = new Intent(SingleDetectActivity.this, SingleDetectActivity.class);
    ...
    View.OnClickListener backOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if ("detectHealth".equals(detectCategory)) {
                switch (type) {
                    case "tizhong":
                        Intent intent1 = new Intent(SingleDetectActivity.this, XinDianDetectActivity.class);
                        intent1.putExtras(getIntent());
            ...
            if ("detectSugar".equals(detectCategory)) {
                switch (type) {
                    case "xueya":
                        ...
                        break;
                    case "xuetang":
                        Intent intent5 = new Intent(SingleDetectActivity.this, XinDianDetectActivity.class);
                        intent5.putExtras(getIntent());
                        intent5.putExtra("sugar", "0");
                        startActivity(intent5);
                        break;
                    case "tizhong":
                        Intent intent1 = new Intent(SingleDetectActivity.this, SingleDetectActivity.class);
                        intent1.putExtras(getIntent());
                        intent1.putExtra("weight", "0");
        ...
        OkGo.<String>post(NetworkApi.Inquiry)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onFinish() {
                        super.onFinish();
                        hideLoadingDialog();
                        InquiryAndFileEndActivity.startMe(SingleDetectActivity.this, "问诊");
                        finish();
