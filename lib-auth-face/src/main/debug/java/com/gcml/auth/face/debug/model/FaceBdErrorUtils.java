...
import com.gcml.auth.face.debug.model.entity.FaceBdAngle;
import com.gcml.auth.face.debug.model.entity.FaceBdFaceInfo;
...
public class FaceBdErrorUtils {
     ...
     * 	95%	    0.994058
     */
    public static final double THRESHOLDS_FACE_LIVENESS = 0.393241;
    ...
    public static String checkSearch(FaceBdSearch search) {
