package com.gcml.module_doctor_advisory.bean;
...
public class DoctorInfoBean implements Serializable {
     ...
     * amount : 704.2
     * gat : 糖尿病，骨科
     * pro : 暨南大学附属第一医院骨科副主任兼运动医学中心主任，医学博士，硕士生导师，副主任医师。从事临床工作近20年，师从广东省医协会运动医学分会主任委员黄华扬教授，主攻运动医学及关节外科，对肩膝髋肘等关节疾病的微创治疗有丰富经验。曾赴美国学习深造、师从SuperPath微创髋关节置换的发明者，Hedley骨科研究所James Chow教授，完成关节和运动医学的专业培训（ISOKAS Fellow）。同时作为访问医师，师从国际肩肘关节大师，北美关节镜协会（AANA）前主席、杜兰大学医学院运动医学部主任Felix Savoie教授以及亚利桑那州立大学骨科主任，NBA凤凰城太阳队首席医师Thomas Carter 教授。
     * pend : 1
     * number : 0
     * evaluation : 75
     * apply_amount : 50
