package com.gcml.auth.face.dialog;
    ...
    public static class Builder {
        ...
        public LoadingDialog create(boolean cancelable) {
            ...
            if (mCurrentIconType == ICON_TYPE_LOADING) {
                ...
                loadingView.setSize(ScreenUtils.dp2px(64));
                ...
                LinearLayout.LayoutParams imageViewLP = new LinearLayout.LayoutParams(ScreenUtils.dp2px( 64), ScreenUtils.dp2px( 64));
            ...
            if (mTipWord != null && mTipWord.length() > 0) {
                ...
                if (mCurrentIconType != ICON_TYPE_NOTHING) {
                    tipViewLP.topMargin = ScreenUtils.dp2px( 24);
                }
