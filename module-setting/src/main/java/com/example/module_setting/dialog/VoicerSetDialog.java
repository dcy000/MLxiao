...
import com.example.module_setting.bean.VoicerBean;
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            holder.rvItem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    MLVoiceSynthetize.startSynthesize("主人,我是" + name.replaceAll("/", ""));
                }
            });
        }
...
//            synthesizer.setParameter(SpeechConstant.SAMPLE_RATE, sharedPreferences.getString("rate_preference", "16000"));
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ImageView ivCheck;
            @BindView(R2.id.tv_voicer)
            TextView tvVoicer;
            @BindView(R2.id.rv_item)
