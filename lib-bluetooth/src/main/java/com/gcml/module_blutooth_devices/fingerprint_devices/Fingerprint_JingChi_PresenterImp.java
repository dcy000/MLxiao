 ...
 */
public class Fingerprint_JingChi_PresenterImp extends BaseBluetoothPresenter {
    /**
     * 第一次连接设备
     */
            ...
            switch (msg.what) {
                case 0xA0:
                    ...
                    if (intGetError < 0) {
                         ...
                         */
                        Logg.e(Fingerprint_JingChi_PresenterImp.class, "出错了：错误代码" + intGetError);
                    }
                    break;
                case 0xA1://实时侦查蓝牙的状态
                    ...
                    if (intBTStatus == 3) {//成功连接蓝牙设备
                        ...
                        SPUtil.put(fragment.getThisContext(),SPUtil.SP_SAVE_FINGERPRINT,bluetoothName+","+bluetoothMac);
                ...
                case 0xB3://获取指纹图像
                    ...
                    fragment.updateData("image", BitmapAndStringUtils.convertIconToString(bitmap));
                    break;
                ...
                case 0xB5://获得指纹模板(指纹录入)
                    Logg.e(Fingerprint_JingChi_PresenterImp.class, "该方法调用次数");
                    ...
                    if (lenTPT == 256) { // 获取指纹模板成功
                        ...
                        Logg.e(Fingerprint_JingChi_PresenterImp.class, "获取指纹模板失败");
                    }
                    break;
                ...
                case RESOLVE_ACTION:
                    switch (action) {
                        case ACTION_COLLECT_FINGERPRINT://指纹录入
                            ...
                            Logg.e(Fingerprint_JingChi_PresenterImp.class, "请按下手指");
                            break;
    ...
    public Fingerprint_JingChi_PresenterImp(IView fragment, DiscoverDevicesSetting discoverSetting) {
        super(fragment, discoverSetting);
        myHandler = new MyHandler(baseView,targetName,targetAddress);
        Logg.e(Fingerprint_JingChi_PresenterImp.class, "初始化");
        gfpInterface = new GfpInterface(fragment.getThisContext(), myHandler);
        myHandler.setGfpInterface(gfpInterface);
        Logg.e(Fingerprint_JingChi_PresenterImp.class, "初始化结束");
    ...
    public void onDestroy() {
        ...
        if (gfpInterface != null) {
            if (gfpInterface.sysCheckBTConnected()) {
                ...
                Logg.e(Fingerprint_JingChi_PresenterImp.class,"关闭相关东西");
            ...
            try {
                ...
                e.printStackTrace();
                Logg.e(Fingerprint_JingChi_PresenterImp.class, e.getMessage());
            }
        }
    ...
    public void collectFingers() {
        ...
        if (myHandler.getIntBTStatus() != 3) {
            Logg.e(Fingerprint_JingChi_PresenterImp.class, "未连接");
    ...
    public void connectDevice(String macAddress) {
        if (!isConnected) {
            Logg.e(Fingerprint_JingChi_PresenterImp.class, "尝试连接设备：" + targetName);
