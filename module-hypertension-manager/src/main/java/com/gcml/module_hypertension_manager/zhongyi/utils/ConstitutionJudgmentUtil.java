package com.gcml.module_hypertension_manager.zhongyi.utils;

import android.graphics.Point;

import com.gcml.module_hypertension_manager.zhongyi.bean.ConstitutionJudgmentEnum;
import com.gcml.module_hypertension_manager.zhongyi.bean.QuestionnaireBean;
...
//    转化分数=[（原始分-条目数（每项问题数））/（条目数×4）] ×100
     ...
     */
    public static Point getScore(List<QuestionnaireBean.QuestionListBean> data, ConstitutionJudgmentEnum info) {
        ...
        for (int i = 0; i < size; i++) {
            if (data.get(i).questionInfo.equals(info.getDescription())) {
    ...
    public static String getMonitorResult(List<QuestionnaireBean.QuestionListBean> data) {
     ...
     * 偏颇
     */
    public static Map<String, Integer> getPianPO(List<QuestionnaireBean.QuestionListBean> data) {
     ...
     * 倾向
     */
    public static Map<String, Integer> getQingXiang(List<QuestionnaireBean.QuestionListBean> data) {
        Map<String, Integer> map = new HashMap<>();
        Point scoreB = getScore(data, ConstitutionJudgmentEnum.B);
        Point scoreC = getScore(data, ConstitutionJudgmentEnum.C);
        Point scoreD = getScore(data, ConstitutionJudgmentEnum.D);
     ...
     * 倾向
     */
    public static Map<String, Integer> getPianPoNot(List<QuestionnaireBean.QuestionListBean> data) {
        Map<String, Integer> map = new HashMap<>();
        Point scoreB = getScore(data, ConstitutionJudgmentEnum.B);
        Point scoreC = getScore(data, ConstitutionJudgmentEnum.C);
        Point scoreD = getScore(data, ConstitutionJudgmentEnum.D);
    ...
    public static Map<String, Integer> getAll(List<QuestionnaireBean.QuestionListBean> data) {
        Map<String, Integer> map = new HashMap<>();
        Point scoreA = getScore(data, ConstitutionJudgmentEnum.A);
        Point scoreB = getScore(data, ConstitutionJudgmentEnum.B);
        Point scoreC = getScore(data, ConstitutionJudgmentEnum.C);
