...
import com.example.module_child_edu.ui.ChildEduHomeActivity;
...
public class PersonDetailFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(com.example.module_person.R.layout.activity_person, container, false);

        headImg = (ImageView) view.findViewById(com.example.module_person.R.id.per_image);
        recreation = (ImageView) view.findViewById(com.example.module_person.R.id.iv_laoren_yule);
        recreation.setOnClickListener(this);
        tvBalance = (TextView) view.findViewById(com.example.module_person.R.id.tv_balance);
        view.findViewById(com.example.module_person.R.id.main_iv_health_class).setOnClickListener(this);
        isSignDoctor = (TextView) view.findViewById(com.example.module_person.R.id.doctor_status);
        isSignDoctor.setOnClickListener(this);
        education = (ImageView) view.findViewById(com.example.module_person.R.id.iv_youjiao_wenyu);
        education.setOnClickListener(this);
        yuLe = (ImageView) view.findViewById(com.example.module_person.R.id.main_iv_old);
        yuLe.setOnClickListener(this);
        view.findViewById(com.example.module_person.R.id.iv_message).setOnClickListener(this);
        view.findViewById(com.example.module_person.R.id.iv_check).setOnClickListener(this);
        view.findViewById(com.example.module_person.R.id.view_wifi).setOnClickListener(this);
        view.findViewById(com.example.module_person.R.id.iv_record).setOnClickListener(this);
        view.findViewById(com.example.module_person.R.id.iv_jiankang_riji).setOnClickListener(this);
        tvUserName = (TextView) view.findViewById(com.example.module_person.R.id.per_name);
        view.findViewById(com.example.module_person.R.id.iv_change_account).setOnClickListener(this);
        headImg.setOnClickListener(this);
        view.findViewById(com.example.module_person.R.id.tv_update).setOnClickListener(this);
        mIvAlarm = (ImageView) view.findViewById(com.example.module_person.R.id.iv_alarm);
        mIvAlarm.setOnClickListener(this);
        signDoctorName = (TextView) view.findViewById(com.example.module_person.R.id.doctor_name);
        ((TextView) view.findViewById(com.example.module_person.R.id.tv_update)).setText("检查更新 v" + AppUtils.getAppInfo().getVersionName());
    ...
    private void getData() {
        ...
        Glide.with(Box.getApp())
                .applyDefaultRequestOptions(new RequestOptions()
                        .placeholder(com.example.module_person.R.drawable.avatar_placeholder)
                        .error(com.example.module_person.R.drawable.avatar_placeholder))
                .load(user.userPhoto)
                .into(headImg);
        ...
        if (TextUtils.isEmpty(user.doid)) {
            ...
            Box.getRetrofit(DoctorAPI.class)
                    ...
                    .compose(RxUtils.<Doctor>httpResponseTransformer())
                    .as(RxUtils.<Doctor>autoDisposeConverter(this))
        ...
        Box.getRetrofit(CommonAPI.class)
                ...
                .as(RxUtils.<RobotAmount>autoDisposeConverter(this))
                .subscribe(new CommonObserver<RobotAmount>() {
                    @Override
                    public void onNext(RobotAmount robotAmount) {
                        if (robotAmount.getAmount() != null) {
                            tvBalance.setText(String.format(getString(com.example.module_person.R.string.robot_amount), robotAmount.getAmount()));
                        }
                    }
                });
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.example.module_person.R.id.iv_check://病症自查
                UserInfoBean user = Box.getSessionManager().getUser();
                ...
                break;
            case com.example.module_person.R.id.iv_message:
                startActivity(new Intent(getActivity(), MessageActivity.class));
                break;
            case com.example.module_person.R.id.iv_laoren_yule:
                OldRouter.routeToOldHomeActivity(getActivity());
                break;
            case com.example.module_person.R.id.iv_change_account:
                mChangeAccountDialog = new ChangeAccountDialog(getActivity());
                mChangeAccountDialog.show();
                break;
            case com.example.module_person.R.id.per_image:
                startActivity(new Intent(getActivity(), MyBaseDataActivity.class));
                break;
            case com.example.module_person.R.id.iv_record:
                startActivity(new Intent(getActivity(), HealthRecordActivity.class));
                break;
            case com.example.module_person.R.id.iv_jiankang_riji:
                startActivity(new Intent(getActivity(), HealthDiaryActivity.class));
                break;
            case com.example.module_person.R.id.tv_update:
                ((ToolbarBaseActivity) getActivity()).showLoadingDialog("检查更新中");
                Box.getRetrofit(CommonAPI.class)
                        ...
                        .doOnTerminate(new Action() {
                            ...
                            public void run() throws Exception {
                                ((ToolbarBaseActivity) getActivity()).hideLoadingDialog();
                            }
                        })
                ...
                break;
            case com.example.module_person.R.id.main_iv_health_class:
                startActivity(new Intent(getActivity(), VideoListActivity.class));
                break;
            case com.example.module_person.R.id.doctor_status:
                ...
                break;
            case com.example.module_person.R.id.iv_youjiao_wenyu:
                Intent intentYoujiao = new Intent(getActivity(), ChildEduHomeActivity.class);
                startActivity(intentYoujiao);
                break;
            case com.example.module_person.R.id.main_iv_old:
                OldRouter.routeToOldHomeActivity(getActivity());
                break;
            case com.example.module_person.R.id.iv_alarm:
