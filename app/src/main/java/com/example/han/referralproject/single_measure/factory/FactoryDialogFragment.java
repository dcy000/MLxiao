...
public class FactoryDialogFragment extends DialogFragment {
    ...
    public static FactoryDialogFragment newInstance(String text) {
        return newInstance(text, 0f, false, true);
    }

    public static FactoryDialogFragment newInstance(
            String text,
            float dimAmount,
            boolean showBottom,
            boolean cancelable) {
        ...
        FactoryDialogFragment fragment = new FactoryDialogFragment();
    ...
    public View onCreateView(
       ...
       /* findViewById(R.id.health_diary_tv_week_report).setOnClickListener(new View.OnClickListener() {
        ...
        findViewById(R.id.health_diary_tv_week_report).setVisibility(View.GONE);
       /* findViewById(R.id.health_diary_tv_month_report).setOnClickListener(new View.OnClickListener() {
        ...
        findViewById(R.id.health_diary_tv_month_report).setVisibility(View.GONE);
