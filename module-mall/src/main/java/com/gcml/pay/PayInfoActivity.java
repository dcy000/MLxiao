        ...
        public boolean handleMessage(final Message msg) {
            switch (msg.what) {
                ...
                case 2:
                    ...
                    new GoodsRepository()
                            .PayInfo(DeviceUtils.getIMEI(), numbers + "", date.getTime() + "", UserSpHelper.getUserId())
...
//                            speak(getString(R.string.pay_success));
                                ...
                                public void onError(Throwable e) {
                                    sign = false;
                                    Log.e("支付成功同步到我们的后台", "onFailed: " + e.getMessage());
                                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MLVoiceSynthetize.startSynthesize(UM.getApp(), "请使用微信扫码完成充值");
