...
import com.example.module_pay.service.PayAPI;
import com.example.module_pay.utils.BillUtils;
...
public class PayInfoActivity extends ToolbarBaseActivity implements View.OnClickListener {
        ...
        public boolean handleMessage(final Message msg) {
            switch (msg.what) {
                ...
                case 2:
                    ...
                    Box.getRetrofit(PayAPI.class)
                            .recharge(DeviceUtils.getIMEI(), numbers, date.getTime(), Box.getUserId())
                            .compose(RxUtils.<String>httpResponseTransformer())
                            .as(RxUtils.<String>autoDisposeConverter(PayInfoActivity.this))
    ...
    public void initParams(Intent intentArgument) {
        ...
        number = intentArgument.getStringExtra("number");//5000
    }
