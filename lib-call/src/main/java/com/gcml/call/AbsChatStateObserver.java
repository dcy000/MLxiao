...
public abstract class AbsChatStateObserver implements AVChatStateObserver {
    ...
    public void onLowStorageSpaceWarning(long availableSize) {
        Timber.i("onLowStorageSpaceWarning: availableSize=%s", availableSize);
    }
    ...
    public void onUserLeave(String account, int event) {
        Timber.i("onUserLeave: account=%s event=%s", account, event);
    }

    @Override
    public void onLeaveChannel() {
        Timber.i("onLeaveChannel: ");
    }

    @Override
    public void onProtocolIncompatible(int status) {
        Timber.i("onProtocolIncompatible: ");
    }

    @Override
    public void onDisconnectServer() {
        Timber.i("onDisconnectServer: ");
    }

    @Override
    public void onNetworkQuality(String user, int quality, AVChatNetworkStats stats) {
        Timber.i("onNetworkQuality: user=%s quality=%s stats=%s", user, quality, stats);
    }
