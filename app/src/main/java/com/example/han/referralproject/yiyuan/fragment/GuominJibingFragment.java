...
import com.example.han.referralproject.building_record.IFragmentChange;
import com.example.han.referralproject.building_record.MyArraysUtils;

public class GuominJibingFragment extends Fragment implements View.OnClickListener {
    private View view;
