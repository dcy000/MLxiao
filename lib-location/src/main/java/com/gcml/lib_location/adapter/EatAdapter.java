package com.gcml.lib_location.adapter;
...
import com.gcml.lib_location.R;
import com.gcml.lib_location.R2;
...
public class EatAdapter extends RecyclerView.Adapter<EatAdapter.EatHolder> {
    ...
    public class EatHolder extends RecyclerView.ViewHolder {
        @BindView(R2.id.iv_sign_up_eat)
        ImageView ivEat;
        @BindView(R2.id.tv_sign_up_eat)
        TextView tvEat;
        ...
        public void onBind(EatModel eatModel) {
            ...
            tvEat.setTextColor(eatModel.isSelected()
                    ? tvEat.getResources().getColor(android.R.color.white)
