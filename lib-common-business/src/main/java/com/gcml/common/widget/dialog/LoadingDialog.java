...
import com.gcml.common.widget.LoadingView;
    ...
    public static class Builder {
        ...
        public LoadingDialog create(boolean cancelable) {
            ...
            if (mCurrentIconType == ICON_TYPE_LOADING) {
                ...
                loadingView.setSize(DisplayHelper.dp2px(mContext, 64));
                ...
                LinearLayout.LayoutParams imageViewLP = new LinearLayout.LayoutParams(DisplayHelper.dp2px(mContext, 64), DisplayHelper.dp2px(mContext, 64));
            ...
            if (mTipWord != null && mTipWord.length() > 0) {
                ...
                if (mCurrentIconType != ICON_TYPE_NOTHING) {
                    tipViewLP.topMargin = DisplayHelper.dp2px(mContext, 24);
                }
                ...
                tipView.setTextSize(TypedValue.COMPLEX_UNIT_SP, 24);
