...
import com.gcml.module_edu_child.bean.JokeModel;
...
@Route(path = "/edu/child/jokes/activity")
public class ChildEduJokesActivity extends ToolbarBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        synthesizerListener = new MySynthesizerListener();
    ...
    private void replay() {
        ...
        MLVoiceSynthetize.startSynthesize(UM.getApp(), mSentences.get(0), synthesizerListener, false);
    }
        ...
        public void run() {
            ...
            if (results == null) {
                Handlers.ui().post(new Runnable() {
                    @Override
                    public void run() {
                        MLVoiceSynthetize.startSynthesize(UM.getApp(), "没有笑话了， 让我再想想", synthesizerListener, false);
                    }
                });
                return;
            }
