...
public class HealthRecordHeartrateFragment extends BaseFragment implements View.OnClickListener {
...
//        ll1.setLineColor(getResources().getColor(R.color.health_record_picket_line));
        ll1.setLineColor(Box.getColor(R.color.health_record_picket_line));
...
//        ll2.setLineColor(getResources().getColor(R.color.health_record_picket_line));
        ll2.setLineColor(Box.getColor(R.color.health_record_picket_line));
