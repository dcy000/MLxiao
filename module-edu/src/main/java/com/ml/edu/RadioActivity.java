...
import com.ml.edu.data.RadioEntity;
...
public class RadioActivity extends ToolbarBaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ApiHelper.getInstance()
                ...
                .subscribe(new DefaultObserver<List<RadioEntity>>() {
                    @Override
    ...
    private Runnable fetchAction = new Runnable() {
        ...
        public void run() {
            ...
            if (!TextUtils.isEmpty(audiopath)) {
                ...
                dismissLoading();
                MLVoiceSynthetize.startSynthesize(UM.getApp(), "未搜索到该频道，请更换频道再试");
            }
    ...
    private void startPlayActually(String url) {
        ...
        onPlaying();
        mPlayer = new KSYMediaPlayer.Builder(UM.getApp()).build();
        try {
