...
interface ECGResult {
    ...
    String STATE_HEARTBEAT_SO_FAST_TO_ASK_DOCTOR_4 = "波形疑似阵发性心跳过快,请咨询健康顾问";
    String STATE_HEARTBEAT_SLOW_5 = "波形疑似心跳稍缓,请注意休息";
    String STATE_HEARTBEAT_SO_SLOW_6 = "波形疑似心跳过缓,请注意休息";
    String STATE_HEARTBEAT_SO_SLOW_TO_ASK_DOCTOR_7 = "波形疑似偶发心跳间期缩短,请咨询健康顾问";
    String STATE_HEARTBEAT_IRREGULAR_8 = "波形疑似心跳间期不规则,请咨询健康顾问";
    String STATE_HEARTBEAT_FAST_SHORTEN_9 = "波形疑似心跳稍快伴有偶发心跳间期缩短,请咨询健康顾问";
    String STATE_HEARTBEAT_SLOW_SHORTEN_10 = "波形疑似心跳稍缓伴有偶发心跳间期缩短,请咨询健康顾问";
    String STATE_HEARTBEAT_SLOW_SHORTEN_TO_ASK_DOCTOR_11 = "波形疑似心跳稍缓伴有心跳间期不规则,请咨询健康顾问";
    String STATE_HEARTBEAT_DRIFT_12 = "波形有漂移,请重新测量";
    String STATE_HEARTBEAT_FAST_DRIFT_13 = "波形疑似心跳过快伴有波形漂移,请咨询健康顾问";
    String STATE_HEARTBEAT_SLOW_DRIFT_14 = "波形疑似心跳过缓伴有波形漂移,请咨询健康顾问";
    String STATE_HEARTBEAT_DRIFT_SHORTEN_15 = "波形疑似偶发心跳间期缩短伴有波形漂移,请咨询健康顾问";
    String STATE_HEARTBEAT_IRREGULAR_DRIFT_16 = "波形疑似心跳间期不规则伴有波形漂移,请咨询健康顾问";
