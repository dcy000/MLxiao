...
public abstract class BaseRoundProgressBar extends LinearLayout {
    ...
    public BaseRoundProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (isInEditMode()) {
    ...
    public BaseRoundProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
