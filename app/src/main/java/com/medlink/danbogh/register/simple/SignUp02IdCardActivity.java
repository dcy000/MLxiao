...
import com.medlink.danbogh.register.SignUp5MobileVerificationActivity;
...
public class SignUp02IdCardActivity extends BaseActivity {
    ...
    public static Intent newIntent(Context context) {
        Intent intent = new Intent(context, SignUp02IdCardActivity.class);
