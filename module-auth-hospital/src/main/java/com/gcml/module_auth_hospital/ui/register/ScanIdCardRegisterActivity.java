...
public class ScanIdCardRegisterActivity extends AppCompatActivity implements AcountInfoDialog.OnFragmentInteractionListener {
    ...
    private void initView() {
        ...
        authScanIdCardToobar.setData("身 份 证 扫 描 注 册",
                ...
                R.drawable.health_measure_ic_bluetooth_disconnected, null, new ToolBarClickListener() {
                    @Override
    ...
    private OnBluetoothListener onBluetoothListener = new OnBluetoothListener() {
        ...
        public void connectResult(boolean success) {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    authScanIdCardToobar.setResIdRight(R.drawable.health_measure_ic_bluetooth_connected);
                }
            });
        }
        ...
        public void connectionLost() {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    authScanIdCardToobar.setResIdRight(R.drawable.health_measure_ic_bluetooth_disconnected);
                }
            });
        }
    };
