...
public class HistoryTodayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MLVoiceSynthetize.startSynthesize(getApplicationContext(), "欢迎来到历史的今天", false);
        initView();
        initEvent();
        initData();
    }
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (resultData != null && resultData.size() != 0) {
                            ...
                            MLVoiceSynthetize.startSynthesize(getApplicationContext(), "我还不知道历史上的今天发生了什么事,我得去学习一下", false);
                        }
                    }
                });
            }
