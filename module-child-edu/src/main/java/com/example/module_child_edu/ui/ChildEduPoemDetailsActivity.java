...
import com.example.module_child_edu.bean.PoemModel;
...
public class ChildEduPoemDetailsActivity extends ToolbarBaseActivity {
    ...
    public int layoutId(Bundle savedInstanceState) {
        return R.layout.ce_activity_poem_details;
    }
    ...
    private void replay() {
        ...
        MLVoiceSynthetize.startSynthesize(mPoemModel.getTitle() + "," + mPoemModel.getAuthor() + "," + mPoemModel.getDynasty() + "," + mSentences.get(0), voiceListener);
