...
import static com.gcml.gzq.live_media.MediaHelper.getCurrentSpan;
import static com.gcml.gzq.live_media.MediaHelper.getFocusX;
import static com.gcml.gzq.live_media.MediaHelper.getFocusY;
import static com.ksyun.media.player.KSYMediaPlayer.VIDEO_SCALING_MODE_SCALE_TO_FIT;
...
public class TVDisplayActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private IMediaPlayer.OnErrorListener mOnErrorListener = new IMediaPlayer.OnErrorListener() {
        ...
        public boolean onError(IMediaPlayer iMediaPlayer, int i, int i1) {
            Toast.makeText(TVDisplayActivity.this, "播放器遇到错误，播放已退出，错误码:" + i, Toast.LENGTH_SHORT).show();
            videoPlayEnd();
            return false;
        }
    };
...
//            KSYTextureView mVideoView = FloatingPlayer.getInstance().getKSYTextureView();
    ...
    private void initView() {
        ...
        mLiveBack = (ImageView) findViewById(R.id.live_back);
