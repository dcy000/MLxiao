package com.example.han.referralproject.temperature;
...
public class TemperatureActivity extends BaseActivity {
    ...
    private final static String TAG = TemperatureActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*  _lineChart1 = (LineChart) findViewById(R.id.temperature_chart);
        CheckBox cb1 = (CheckBox) findViewById(R.id.temperature_cb);
        CheckBox cb_fill = (CheckBox) findViewById(R.id.cb_fill_temperature);
    ...
    public String DEVICE1_ON = "BBBBB\n";
