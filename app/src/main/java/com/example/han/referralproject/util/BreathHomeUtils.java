...
public class BreathHomeUtils {
     ...
     * @return
     */
    public static double drv_pred_pef(int gender, double age, double height, double weight) { // L/s
    ...
    public static double drv_pred_fev1(int gender, double age, double height, double weight) {// L
    ...
    public static double drv_pred_fvc(int gender, double age, double height, double weight) { // L
     ...
     * @return
     */
    public static int checkPEF(int gender, double age, double height, double weight, float reality) {
     ...
     * @return
     */
    public static int checkFEV1(int gender, double age, double height, double weight, float reality) {
     ...
     * @return
     */
    public static int checkFEV1_FVC(int gender, double age, double height, double weight, float fev1, float fvc) {
        float v = fev1 / fvc;
    ...
    public static String percentPEF(int gender, double age, double height, double weight, float reality){
        double percent = reality / drv_pred_pef(gender, age, height, weight);
        return String.format("%.0f", percent*100)+"%";
    }
    public static String percentFEV1(int gender, double age, double height, double weight, float reality){
        double percent = reality / drv_pred_fev1(gender, age, height, weight);
        return String.format("%.0f", percent*100)+"%";
    }
    public static String percentFEV1_FVC(int gender, double age, double height, double weight, float fev1, float fvc){
        float v = fev1 / fvc;
