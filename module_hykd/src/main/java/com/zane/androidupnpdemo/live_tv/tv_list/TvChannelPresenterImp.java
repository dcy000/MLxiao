...
public class TvChannelPresenterImp implements ITvChannelInteractor.OnParseExcelListener, ITvChannelPresenter {
    ...
    private void speakAndListen() {
        MLVoiceSynthetize.startSynthesize((TvChannelActivity)tvChannelActivity,"主人，您想看哪个电视节目？",false);
        MLVoiceRecognize.startRecognize((TvChannelActivity)tvChannelActivity, new MLRecognizerListener() {
            @Override
