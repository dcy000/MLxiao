...
import com.example.han.referralproject.health.HealthSelectSugarDetectionTimeFragment;
...
import com.example.han.referralproject.measure.single.SingleMeasureECGFragment;
        ...
        if (baseFragment != null && measure_type == IPresenter.MEASURE_ECG) {
            ((ECG_Fragment) baseFragment).setOnAnalysisDataListener(new ECG_Fragment.AnalysisData() {
                ...
                public void onSuccess(String fileNum, String fileAddress, String filePDF) {
                    speak("主人，请查看心电测量报告。点击右上角的按钮可扫描下载");
                    pdfUrl = filePDF;
