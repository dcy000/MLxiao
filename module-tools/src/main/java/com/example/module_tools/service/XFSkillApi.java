package com.example.module_tools.service;

import com.example.module_tools.bean.BaiKeBean;
import com.example.module_tools.bean.ChineseZodiacBean;
import com.example.module_tools.bean.CookbookBean;
import com.example.module_tools.bean.CrossTalkBean;
import com.example.module_tools.bean.DreamBean;
import com.example.module_tools.bean.HealthBean;
import com.example.module_tools.bean.HistoryBean;
import com.example.module_tools.bean.HistoryTodayBean;
import com.example.module_tools.bean.HolidayBean;
import com.example.module_tools.bean.IdiomBean;
import com.example.module_tools.bean.OpenClassBean;
import com.example.module_tools.bean.RiddleBean;
import com.example.module_tools.bean.SpeechBean;
import com.example.module_tools.bean.StoryTellingBean;
import com.example.module_tools.bean.TranslationBean;
import com.example.module_tools.bean.WeatherBean;
import com.example.module_tools.bean.WebsearchBean;
import com.example.module_tools.bean.WordFindingBean;
...
//                    List<ChineseZodiacBean> chineseZodiacBeans = gson.fromJson(result.toString(), type);
    ...
    private static Call initPostCall(String contentText) {
        ...
        RequestBody body = new FormBody.Builder()
                .add("eqid", DeviceUtils.getIMEI())
                .add("text", contentText)
                .build();
        Request request = new Request.Builder()
                .url(Box.getBaseUrl() + "ZZB/xf/xfrq")
                .post(body)
                .build();
