...
public class SignUp12DrinkActivity extends VoiceToolBarActivity {
    ...
    public int layoutId(Bundle savedInstanceState) {
        return R.layout.activity_sign_up12_drink;
    }
    ...
    protected void onResume() {
        ...
        robotStartListening();
        MLVoiceSynthetize.startSynthesize(R.string.sign_up_drink_tip);
    }
    ...
    private void cacheUserInfo(String drink) {
