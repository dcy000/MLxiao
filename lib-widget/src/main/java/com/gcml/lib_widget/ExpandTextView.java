...
public class ExpandTextView extends LinearLayout implements View.OnClickListener {
    ...
    public ExpandTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        titleTextSize = a.getDimension(R.styleable.ExpandTextView_titleTextSize, sp2px(DEFAULT_TITLE_TEXT_SIZE));
        contentTextSize = a.getDimension(R.styleable.ExpandTextView_contentTextSize, sp2px(DEFAULT_CONTENT_TEXT_SIZE));
        hintTextSize = a.getDimension(R.styleable.ExpandTextView_hintTextSize, sp2px(DEFAULT_HINT_TEXT_SIZE));
...
//        mHintView.setTextColor(hintTextColor);
        mHintView.setTextColor(Color.parseColor("#FF999999"));
    ...
    public void setContentTextSize(float contentTextSize) {
        this.contentTextSize = sp2px(contentTextSize);
    ...
    public void setHintTextSize(float hintTextSize) {
        this.hintTextSize = sp2px(hintTextSize);
    ...
    public int getMinMeasureHeight() {
        if (copy == null) {
            ...
            copy.setLineSpacing(dp2px(6), 1.0f);
    ...
    public void expandWithNoAnimation() {
        int startHeight;
        int targetHeight;
        if (!flag) {
            flag = true;
