package com.gcml.lib_widget.progressbar;
...
public class TextRoundProgressBar extends BaseRoundProgressBar implements ViewTreeObserver.OnGlobalLayoutListener {
    protected final static int DEFAULT_TEXT_SIZE = 16;
    protected final static int DEFAULT_TEXT_MARGIN = 10;

    private ImageView tvProgress;
    private int colorTextProgress;
    private int textProgressSize;
    private int textProgressMargin;
    private String textProgress;

    public TextRoundProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TextRoundProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
