...
public class HealthRecordHeartrateFragment extends RecycleBaseFragment implements View.OnClickListener {
    ...
    protected void initView(View view, Bundle bundle) {
        try {
            ...
            //指示器的颜色
            mColor1.setBackgroundColor(UtilsManager.getApplication().getResources().getColor(R.color.health_record_node_color));
    ...
    private void initChart() {
        try {
            ...
            ll1.setLineWidth(2f);
            ll1.setLineColor(UtilsManager.getApplication().getResources().getColor(R.color.health_record_picket_line));
            ...
            ll2.setLineWidth(2f);
            ll2.setLineColor(UtilsManager.getApplication().getResources().getColor(R.color.health_record_picket_line));
    ...
    public void refreshData(List<HeartRateHistory> response, String temp) {
        try {
...
//            set1.enableDashedLine(10f, 0f, 0f);
                    //走势线的颜色
                    set1.setColor(UtilsManager.getApplication().getResources().getColor(R.color.health_record_line_color));
                    //节点圆圈的颜色
                    set1.setCircleColor(UtilsManager.getApplication().getResources().getColor(R.color.health_record_node_color));
