...
public class NDialog2 {
  ...
  //  private String negativeButtonText = "取消";
    ...
    public NDialog2(Context context) {
    ...
    public NDialog2 setCancleable(boolean cancleable) {
        this.cancleable = cancleable;
        return this;
    }


    public NDialog2 setButtonCenter(boolean buttonCenter) {
        isButtonCenter = buttonCenter;
        return this;
    }


    public NDialog2 setOnConfirmListener(OnConfirmListener onConfirmListener) {
        this.onConfirmListener = onConfirmListener;
        return this;
    }

    public NDialog2 setOnInputListener(OnInputListener onInputListener) {
        this.onInputListener = onInputListener;
        return this;
    }

    public NDialog2 setOnChoiceListener(OnChoiceListener onChoiceListener) {
        this.onChoiceListener = onChoiceListener;
        return this;
    }

    public NDialog2 setInputLineColor(int inputLineColor) {
        this.inputLineColor = inputLineColor;
        return this;
    }

    public NDialog2 setInputHintText(String inputHintText) {
        this.inputHintText = inputHintText;
        return this;
    }

    public NDialog2 setInputHintTextColor(int inputHintTextColor) {
        this.inputHintTextColor = inputHintTextColor;
        return this;
    }

    public NDialog2 setInputType(int inputType) {
        this.inputType = inputType;
        return this;
    }

    public NDialog2 setMessageCenter(boolean messageCenter) {
        isMessageCenter = messageCenter;
        return this;
    }

    public NDialog2 setItems(String[] items) {
        this.items = items;
        return this;
    }

    public NDialog2 setItemColor(int itemColor) {
        this.itemColor = itemColor;
        return this;
    }

    public NDialog2 setItemSize(int itemSize) {
        this.itemSize = itemSize;
        return this;
    }

    public NDialog2 setItemGravity(int itemGravity) {
        this.itemGravity = itemGravity;
        return this;
    }

    public NDialog2 setPositiveButtonText(String positiveButtonText) {
        this.positiveButtonText = positiveButtonText;
        return this;
    }

   /* public NDialog2 setNegativeButtonText(String negativeButtonText) {
        this.negativeButtonText = negativeButtonText;
        return this;
    }*/

    public NDialog2 setPositiveTextColor(int positiveTextColor) {
        this.positiveTextColor = positiveTextColor;
        return this;
    }

    public NDialog2 setNegativeTextColor(int negativeTextColor) {
        this.negativeTextColor = negativeTextColor;
        return this;
    }

    public NDialog2 setMessage(String message) {
        this.message = message;
        return this;
    }

    public NDialog2 setMessageSize(int sp) {
        this.messageSize = sp;
        return this;
    }

    public NDialog2 setMessageColor(int messageColor) {
        this.messageColor = messageColor;
        return this;
    }

    public NDialog2 setTitle(String title) {
        this.title = title;
        return this;
    }

    public NDialog2 setTitleSize(int sp) {
        this.titleSize = sp;
        return this;
    }

    public NDialog2 setTitleColor(int titleColor) {
        this.titleColor = titleColor;
        return this;
    }

    public NDialog2 setTitleCenter(boolean titleCenter) {
        isTitleCenter = titleCenter;
        return this;
    }

    public NDialog2 setButtonSize(int buttonSize) {
        this.buttonSize = buttonSize;
        return this;
    }

    public NDialog2 setInputText(String inputText) {
        this.inputText = inputText;
        return this;
    }

    public NDialog2 setInputTextColor(int inputTextColor) {
        this.inputTextColor = inputTextColor;
        return this;
    }

    public NDialog2 setInputTextSize(int sp) {
        this.inputTextSize = sp;
        return this;
    }

    public NDialog2 setHasDivider(boolean hasDivider) {
        this.hasDivider = hasDivider;
        return this;
    }

    public NDialog2 setDividerHeigh(int px) {
        this.dividerHeigh = px;
        return this;
    }

    public NDialog2 setDividerColor(int dividerColor) {
        this.dividerColor = dividerColor;
        return this;
    }

    public NDialog2 setItemHeigh(int dp) {
        this.itemHeigh = dp;
        return this;
    }

    public NDialog2 setAdapter(BaseAdapter adapter) {
