...
/**
 * Created by afirez on 2017/10/12.
 */
public class AuthChangeMobileActivity extends BaseActivity {
    ...
    public static Intent newIntent(Context context) {
        Intent intent = new Intent(context, AuthChangeMobileActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.auth_activity_change_mobile);
...
//    @OnClick(R.id.tv_sign_up_go_forward)
    ...
    private void navToNext(String phone) {
        NetworkApi.updatePhone(MyApplication.getInstance().userId, phone, new NetworkManager.SuccessCallback<Object>() {
            @Override
            public void onSuccess(Object response) {
