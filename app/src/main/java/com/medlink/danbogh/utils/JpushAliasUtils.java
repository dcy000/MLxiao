...
public class JpushAliasUtils {
    ...
    public void setAlias(String userId) {
        ...
        // 调用 Handler 来异步设置别名
        handlerUtils.sendMessage(handlerUtils.obtainMessage(MSG_SET_ALIAS, userId));
    }
...
//                    handlerUtils.sendMessageDelayed(handlerUtils.obtainMessage(MSG_SET_ALIAS, alias), 1000 * 60);
//                    break;
//                default:
...
//    };
    ...
    HandlerUtils.HandlerHolder handlerUtils=new HandlerUtils.HandlerHolder(new HandlerUtils.OnReceiveMessageListener() {
        @Override
        public void handlerMessage(Message msg) {
            switch (msg.what) {
                case MSG_SET_ALIAS:
                    Log.d(TAG, "Set alias in handler.");
                    // 调用 JPush 接口来设置别名。
                    JPushInterface.setAlias(context.getApplicationContext(),-200,(String)msg.obj);
//                    JPushInterface.setAliasAndTags(context.getApplicationContext(),
//                            (String) msg.obj,
//                            null,
//                            mAliasCallback);
