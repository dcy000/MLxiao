...
public class FamilyFriendFragment extends Fragment {

    private View mView;
    private RecyclerView mRecycler;
    private FamilyFriendAdapter mAdapter;
    ...
    private void bindData() {
        ...
        for (int i = 0; i < 10; i++) {
            if (i < 5) {
                list.add(new FamilyBean("郭志强", "朋友"));
            } else {
                list.add(new FamilyBean("曾庆森", "同学"));
            }
        }
        mAdapter = new FamilyFriendAdapter(R.layout.item_family_menu, list);
