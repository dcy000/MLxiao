...
//
public class SheQuYiShengActivity extends BaseActivity implements View.OnClickListener {

//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_she_qu_yi_sheng);
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NetworkApi.onlinedoctor_list(status, "", page, 9, new NetworkManager.SuccessCallback<ArrayList<Docter>>() {
            @Override
            public void onSuccess(ArrayList<Docter> response) {
