package com.gcml.module_factory_test.adapter;
...
import com.gcml.module_factory_test.dialog.InputDialog;
import com.gcml.module_factory_test.utils.RxUtils;
import com.gcml.module_factory_test.utils.WiFiUtil;
...
public class WifiConnectRecyclerAdapter extends RecyclerView.Adapter<WifiConnectRecyclerAdapter.WifiHolder> {
    ...
    public WifiConnectRecyclerAdapter.WifiHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new WifiHolder(mInflater.inflate(R.layout.factory_item_wifi_info_layout, null));
    }
    ...
    public void onBindViewHolder(WifiConnectRecyclerAdapter.WifiHolder holder, int position) {
        ...
        RxUtils.rxWifiLevels(mContext, 4, itemResult)
