...
import com.gcml.mod_hyper_manager.bean.DailyRecommendIntake;
import com.gcml.mod_hyper_manager.bean.FoodMateratilDetail;
...
public class DietPlanFragment extends Fragment implements View.OnClickListener {
    ...
    private void getData() {
        ...
        repository.getDailyRecommendedIntake(UserSpHelper.getUserId())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .as(RxUtils.autoDisposeConverter(this))
                .subscribe(new DefaultObserver<DailyRecommendIntake>() {
                    @Override
                    public void onNext(DailyRecommendIntake dailyRecommendIntake) {
                        dealTopData(dailyRecommendIntake);
                    }
        ...
        repository.getDailyFoodRecommendation(UserSpHelper.getUserId())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .as(RxUtils.autoDisposeConverter(this))
                .subscribe(new DefaultObserver<ArrayList<FoodMateratilDetail>>() {
                    @Override
                    public void onNext(ArrayList<FoodMateratilDetail> foodMateratilDetails) {
                        dealBottomData(foodMateratilDetails);
                    }
...
//                ((TreatmentPlanActivity) getActivity()).speak("您本周每日食盐量应少于" + topData.getNaSalt()
