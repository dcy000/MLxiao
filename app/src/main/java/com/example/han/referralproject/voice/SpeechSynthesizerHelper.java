...
public class SpeechSynthesizerHelper {
     ...
     * 初始化语音合成对象 是否采用默认参数
     */
    public static SpeechSynthesizer initSpeechSynthesizer(Context context, InitListener initListener, boolean defualtParam) {
    ...
    public static void startSynthesize(Context context, String text) {
        startSynthesize(context, false, text);
    }
