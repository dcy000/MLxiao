...
public class AllMeasureActivity extends BaseActivity implements FragmentChanged, ThreeInOne_Fragment.MeasureItemChanged {
            ...
            switch (measureType) {
                ...
                case IPresenter.MEASURE_OTHERS:
                    ...
                    if (threeInOnePosition.size() == 0) {
                        HealthRecordActivity.startActivity(AllMeasureActivity.this,6);
                    } else {
                        HealthRecordActivity.startActivity(AllMeasureActivity.this,threeInOnePosition.get(threeInOnePosition.size() - 1));
                    }
                    break;
                default:
                    break;
