...
import com.zane.androidupnpdemo.connect_tv.control.callback.ControlReceiveCallback;
...
public class TVConnectMainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, SeekBar.OnSeekBarChangeListener {

    private static final String TAG = TVConnectMainActivity.class.getSimpleName();
    /** 连接设备状态: 播放状态 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tv_connect_activity_main);
        mContext = this;
    ...
    private void bindServices() {
        // Bind UPnP service
        Intent upnpServiceIntent = new Intent(TVConnectMainActivity.this, ClingUpnpService.class);
        bindService(upnpServiceIntent, mUpnpServiceConnection, Context.BIND_AUTO_CREATE);
        // Bind System service
        //        Intent systemServiceIntent = new Intent(TVConnectMainActivity.this, SystemService.class);
