package com.gcml.lib_widget.rulerview;
...
public class RulerView extends View {
    ...
    protected void init(Context context, AttributeSet attrs) {
        ...
        mLineSpaceWidth = typedArray.getDimension(R.styleable.RulerView_ruler_lineSpaceWidth, mLineSpaceWidth);
        mLineWidth = typedArray.getDimension(R.styleable.RulerView_ruler_lineWidth, mLineWidth);
        mLineMaxHeight = typedArray.getDimension(R.styleable.RulerView_ruler_lineMaxHeight, mLineMaxHeight);
        mLineMidHeight = typedArray.getDimension(R.styleable.RulerView_ruler_lineMidHeight, mLineMidHeight);
        mLineMinHeight = typedArray.getDimension(R.styleable.RulerView_ruler_lineMinHeight, mLineMinHeight);
        ...
        mTextMarginTop = typedArray.getDimension(R.styleable.RulerView_ruler_textMarginTop, mTextMarginTop);
