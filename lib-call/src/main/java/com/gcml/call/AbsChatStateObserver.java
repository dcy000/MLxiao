...
public abstract class AbsChatStateObserver implements AVChatStateObserver {
    ...
    public void onUserJoined(String account) {
        Timber.tag(TAG).d("onUserJoined:account=%s", account);
    }
    ...
    public void onVideoFrameResolutionChanged(String user, int width, int height, int rotate) {
        Timber.tag(TAG).d("onVideoFrameResolutionChanged: user=%s width=%s, height=%s, rotate=%s", user, width, height, rotate);
    }
    ...
    public void onLiveEvent(int event) {
        Timber.tag(TAG).d("onLiveEvent: event=%s", event);
    }
}
