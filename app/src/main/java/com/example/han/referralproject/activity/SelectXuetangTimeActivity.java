        ...
        switch (v.getId()) {
            case R.id.one_hour:
                startActivity(new Intent(this, DetectActivity.class)
                        .putExtra("time", 1).putExtra("type", detectType).putExtra("isSkip", getIntent().getBooleanExtra("isSkip", false)));
                break;
            case R.id.two_hour:
                startActivity(new Intent(this, DetectActivity.class)
                        .putExtra("time", 2).putExtra("type", detectType).putExtra("isSkip", getIntent().getBooleanExtra("isSkip", false)));
                break;
            case R.id.kongfu:
                startActivity(new Intent(this, DetectActivity.class)
                        .putExtra("time", 0).putExtra("type", detectType).putExtra("isSkip", getIntent().getBooleanExtra("isSkip", false)));
                break;
        }
    }
}
