package com.gcml.lib_widget.recycleview;
...
public class GridViewDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public GridViewDividerItemDecoration(int leftRight, int topBottom, int mColor) {
    ...
    public GridViewDividerItemDecoration(int leftRight, int topBottom){
        this.leftRight = leftRight;
        this.topBottom = topBottom;
