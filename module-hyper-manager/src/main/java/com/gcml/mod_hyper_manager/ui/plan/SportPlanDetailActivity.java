...
public class SportPlanDetailActivity extends ToolbarBaseActivity {
    ...
    private void dealData() {
        ...
        if (!TextUtils.isEmpty(data.getHypertensionEffect())){
            MLVoiceSynthetize.startSynthesize(UM.getApp(),""+name+sportEffect+"对血压的好处"+data.getHypertensionEffect());
        }
        if (!TextUtils.isEmpty(data.getDiabetesEffect())){
            MLVoiceSynthetize.startSynthesize(UM.getApp(),""+name+sportEffect+"对血糖的好处"+data.getDiabetesEffect());
        }
    }
