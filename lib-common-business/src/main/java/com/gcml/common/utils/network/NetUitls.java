package com.gcml.common.utils.network;
...
//            Log.d("----result---", "result = " + result);
    ...
    public static boolean isWifiEnabled() {
        ConnectivityManager mgrConn = (ConnectivityManager) getApplication().getSystemService(Context.CONNECTIVITY_SERVICE);
        TelephonyManager mgrTel = (TelephonyManager) getApplication().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static void openWirelessSettings() {
        if (Build.VERSION.SDK_INT > 10) {
            getApplication().startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS));
        } else {
            getApplication().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS));
        }
    }
