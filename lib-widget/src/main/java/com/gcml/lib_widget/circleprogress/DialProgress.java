package com.gcml.lib_widget.circleprogress;
...
import com.gcml.lib_widget.BuildConfig;
...
public class DialProgress extends View {
    ...
    private void initConfig(Context context, AttributeSet attrs) {
        ...
        antiAlias = typedArray.getBoolean(R.styleable.DialProgress_cp_antiAlias, true);
        mMaxValue = typedArray.getFloat(R.styleable.DialProgress_cp_maxValue, Constant.DEFAULT_MAX_VALUE);
        mValue = typedArray.getFloat(R.styleable.DialProgress_cp_value, Constant.DEFAULT_VALUE);
        mValueSize = typedArray.getDimension(R.styleable.DialProgress_cp_valueSize, Constant.DEFAULT_VALUE_SIZE);
        mValueColor = typedArray.getColor(R.styleable.DialProgress_cp_valueColor, Color.BLACK);
        mDialIntervalDegree = typedArray.getInt(R.styleable.DialProgress_cp_dialIntervalDegree, 10);
        int precision = typedArray.getInt(R.styleable.DialProgress_cp_precision, 0);
        mPrecisionFormat = MiscUtil.getPrecisionFormat(precision);

        mUnit = typedArray.getString(R.styleable.DialProgress_cp_unit);
        mUnitColor = typedArray.getColor(R.styleable.DialProgress_cp_unitColor, Color.BLACK);
        mUnitSize = typedArray.getDimension(R.styleable.DialProgress_cp_unitSize, Constant.DEFAULT_UNIT_SIZE);

        mHint = typedArray.getString(R.styleable.DialProgress_cp_hint);
        mHintColor = typedArray.getColor(R.styleable.DialProgress_cp_hintColor, Color.BLACK);
        mHintSize = typedArray.getDimension(R.styleable.DialProgress_cp_hintSize, Constant.DEFAULT_HINT_SIZE);

        mArcWidth = typedArray.getDimension(R.styleable.DialProgress_cp_arcWidth, Constant.DEFAULT_ARC_WIDTH);

        mStartAngle = typedArray.getFloat(R.styleable.DialProgress_cp_startAngle, Constant.DEFAULT_START_ANGLE);
        mSweepAngle = typedArray.getFloat(R.styleable.DialProgress_cp_sweepAngle, Constant.DEFAULT_SWEEP_ANGLE);

        mAnimTime = typedArray.getInt(R.styleable.DialProgress_cp_animTime, Constant.DEFAULT_ANIM_TIME);

        mBgArcColor = typedArray.getColor(R.styleable.DialProgress_cp_bgArcColor, Color.GRAY);
        mDialWidth = typedArray.getDimension(R.styleable.DialProgress_cp_dialWidth, 2);
        mDialColor = typedArray.getColor(R.styleable.DialProgress_cp_dialColor, Color.WHITE);

        mTextOffsetPercentInRadius = typedArray.getFloat(R.styleable.DialProgress_cp_textOffsetPercentInRadius, 0.33f);

        int gradientArcColors = typedArray.getResourceId(R.styleable.DialProgress_cp_arcColors, 0);
