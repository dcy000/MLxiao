 ...
 * description:TODO
 */
public class BloodpressureAbnormalActivity extends ToolbarBaseActivity implements HealthMeasureChooseAbnormalReason {
    ...
    public static void startActivity(Object host, int measureType, int requestCode) {
        if (host instanceof Activity) {
            Intent intent = new Intent(((Activity) host), BloodpressureAbnormalActivity.class);
            intent.putExtra(KEY_MEASURE_TYPE, measureType);
            ((Activity) host).startActivityForResult(intent, requestCode);
            Timber.e("BloodpressureAbnormalActivity：activity");
        } else if (host instanceof Fragment) {
            Intent intent = new Intent(((Fragment) host).getContext(), BloodpressureAbnormalActivity.class);
            intent.putExtra(KEY_MEASURE_TYPE, measureType);
            ((Fragment) host).startActivityForResult(intent, requestCode);
            Timber.e("BloodpressureAbnormalActivity：Fragment");
        }
    ...
    private void initFragment() {
        ...
        if (baseFragment != null) {
            ...
            Timber.e("BloodpressureAbnormalActivity：初始化Fragment失败");
        }
    }
