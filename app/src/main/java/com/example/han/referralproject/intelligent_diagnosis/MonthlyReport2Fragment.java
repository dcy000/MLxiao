 ...
 */
public class MonthlyReport2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvTitle.setText("本月目标");
        tvWeekTitle.setText("本月平均血压");
        return view;
    }
    ...
    public void notifyData(MonthlyReport.MAPQ weeklyReport) {
        ...
        if (data != null) {
            ...
            if (sj_gaoya < mb_gaoya && sj_diya < mb_diya) {
                tips = "您好，恭喜您本月血压降至目标值以下，请继续保持良好的生活习惯,积极锻炼。查看详细的报告，请向左滑动页面！";

            } else if (sj_diya < mb_diya) {
                tips = "您好，恭喜您本月舒张压降至目标值以下，但收缩压仍然偏高。本周计划完成"
                        + (int) progress_percent + "%。请继续根据机器人的指导保持良好的生活习惯，积极锻炼。查看详细的报告，请向左滑动页面！";
            } else if (sj_gaoya < mb_gaoya) {
                tips = "您好，恭喜您本月收缩压降至目标值以下，但舒张压仍然偏高。本周计划完成"
                        + (int) progress_percent + "%。请继续根据机器人的指导保持良好的生活习惯，积极锻炼。查看详细的报告，请向左滑动页面！";
            } else {
                tips = "您好，您的血压仍偏高。本月计划完成"
