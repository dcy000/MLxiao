    ...
    protected void convert(final BaseViewHolder baseViewHolder, final BloodSugarRisk testBean) {
        ...
        switch (testBean.getItemType()) {
            case BloodSugarRisk.FOUR_BUTTON:
                ...
                baseViewHolder.setText(R.id.four_question, testBean.getQuestionName());
            ...
            case BloodSugarRisk.THREE_BUTTON_HORIZONTAL:
                ...
                baseViewHolder.setText(R.id.threeh_question, testBean.getQuestionName());
            ...
            case BloodSugarRisk.TWO_BUTTON:
                ...
                baseViewHolder.setText(R.id.question, testBean.getQuestionName());
            ...
            case BloodSugarRisk.THREE_BUTTON_VERTICAL:
                ...
                baseViewHolder.setText(R.id.threev_question, testBean.getQuestionName());
