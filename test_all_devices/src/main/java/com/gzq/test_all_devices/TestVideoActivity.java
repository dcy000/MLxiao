...
import com.gcml.module_health_record.algorithm.UnitWeekHealthRecord;
import com.google.gson.Gson;
import com.gzq.test_all_devices.health_record_bean.WeeklyOrMonthlyReport;
...
//                    }
//                });
//        UnitWeekHealthRecord unitWeekHealthRecord = new UnitWeekHealthRecord();
//        long l = System.currentTimeMillis();
//        Log.e(TAG, "onCreate: 周一" + com.gcml.lib_utils.data.TimeUtils.date2String(unitWeekHealthRecord.getTheDayMonday(l)));
//        Log.e(TAG, "onCreate: 周日" + com.gcml.lib_utils.data.TimeUtils.date2String(unitWeekHealthRecord.getTheDaySunday(l)));
        getData();
    }
    private void getData() {
        Calendar curr = Calendar.getInstance();
        long thisWeekTime = curr.getTimeInMillis();
        OkGo.<String>get(NetworkApi.WeeklyOrMonthlyReport)
                .params("userId", "100034")
                .params("endTimeStamp", thisWeekTime)
                .params("num", "1")
                .execute(new StringCallback() {
                    @Override
                    public void onSuccess(Response<String> response) {
