...
public class KSYPlayer extends BaseInternalPlayer {
    private static String TAG="KSYPlayer";
    ...
    static {
        ...
        KSYMediaPlayer.native_profileBegin("libijkplayer.so");
    }
    ...
    private KSYMediaPlayer createPlayer(){
        mAppContext = AppContextAttach.getApplicationContext();
        KSYMediaPlayer ksyMediaPlayer = new KSYMediaPlayer.Builder(mAppContext).build();
//        //open mediacodec
//        ksyMediaPlayer.setOption(KSYMediaPlayer.OPT_CATEGORY_PLAYER, "mediacodec", 1);
//
//        //accurate seek
//        ksyMediaPlayer.setOption(KSYMediaPlayer.OPT_CATEGORY_PLAYER, "enable-accurate-seek", 1);
//
//        ksyMediaPlayer.setOption(KSYMediaPlayer.OPT_CATEGORY_PLAYER, "mediacodec-auto-rotate", 1);
//        ksyMediaPlayer.setOption(KSYMediaPlayer.OPT_CATEGORY_PLAYER, "opensles", 1);
//        ksyMediaPlayer.setOption(KSYMediaPlayer.OPT_CATEGORY_PLAYER, "framedrop", 1);
//        ksyMediaPlayer.setOption(KSYMediaPlayer.OPT_CATEGORY_PLAYER, "start-on-prepared", 0);
//
//        ksyMediaPlayer.setOption(KSYMediaPlayer.OPT_CATEGORY_FORMAT, "timeout", 10000000);
//        ksyMediaPlayer.setOption(KSYMediaPlayer.OPT_CATEGORY_FORMAT, "reconnect", 1);
//
//        ksyMediaPlayer.setOption(KSYMediaPlayer.OPT_CATEGORY_FORMAT, "http-detect-range-support", 0);
//
//        ksyMediaPlayer.setOption(KSYMediaPlayer.OPT_CATEGORY_CODEC, "skip_loop_filter", 48);
    ...
    private void openVideo(DataSource dataSource) {
        try {
            if(mMediaPlayer==null){
                mMediaPlayer = new KSYMediaPlayer.Builder(mAppContext).build();
            }else{
                stop();
                reset();
                resetListener();
